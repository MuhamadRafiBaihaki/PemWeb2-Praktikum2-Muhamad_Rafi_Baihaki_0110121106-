    ...
    <script>
        ...
        function validasi() {
            ...
            if(nama_ == "" && matkul == "" && uts_ == "" && uas_ == "" && tugas_ == "" ) {
                ...
                document.getElementById("action").action = `nilai_siswa.php`;
            }
        }
    </script>
    <style>
...
<body>
    ...
    <a style="text-decoration: none;" href="" onmouseover="dekor1()" onmouseout="dekor2()" id="home"><h2>Welcome to Muhamad Rafi Baihaki's Table of Praktikum 2</h2></a>
    <hr>
    <br>
